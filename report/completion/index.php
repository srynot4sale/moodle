...
foreach ($progress as $user) {
    ...
    foreach ($criteria as $criterion) {
        ...
        $a = new stdClass();
        $a->state    = $describe;
        $a->date     = $is_complete ? userdate($criteria_completion->timecompleted, get_string('strftimedatetimeshort', 'langconfig')) : '';
        $a->user     = fullname($user);
    ...
    $a = new StdClass;
    $a->state    = $describe;
    $a->date     = $ccompletion->is_complete() ? userdate($ccompletion->timecompleted, get_string('strftimedatetimeshort', 'langconfig')) : '';
    $a->user     = fullname($user);
